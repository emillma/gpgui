...
class CallbackContext:
    """This class is implemented as async-dash breaks the context system of dash

    TODO: make this more similar to dash.ctx
    """
    ...
    def triggered(self):
        ...
        return quart.g.triggered_inputs
...
monkey_callback_context = CallbackContext()
